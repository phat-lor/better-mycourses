...
export default function CoursesPage() {
  ...
  // Course statistics for potential future use
  // const totalCourses = user?.courses.length || 0;
  // const favoriteCourses = user?.courses.filter((course) => course.isfavourite).length || 0;
  // const inProgressCourses = user?.courses.filter(
  //   (course) => course.hasprogress && course.progress > 0 && course.progress < 100
  // ).length || 0;
