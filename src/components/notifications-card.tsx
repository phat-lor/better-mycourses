  ...
  all: [
    {
      ...
      description: "requested to join your Better MyCourses organization.",
      name: "Tony Reichert",
      time: "2 hours ago",
      type: "request",
    },
    {
      ...
      description: "modified the Course schedule file.",
      name: "Ben Berman",
      time: "7 hours ago",
      type: "file",
    },
    {
      ...
      description: "liked your course submission.",
      name: "Jane Doe",
      time: "Yesterday",
    },
    {
    ...
    },
    {
      ...
      description: "mentioned you in a course discussion.",
      name: "Jacob Jones",
      time: "2 days ago",
    },
    {
      ...
      description: "commented on your assignment.",
      name: "Amelie Dawson",
      time: "4 days ago",
    },
  ],
